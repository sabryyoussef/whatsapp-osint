...
### 2. أبحاث استخبارات المصادر المفتوحة (OSINT)
تُستخدم هذه الأداة من قِبل:
- **الباحثين الأمنيين** لدراسة أنماط سلوك المستخدمين وتقييم مخاطر الخصوصية.
- **مختبري الاختراق الأخلاقيين** لإثبات ما يمكن استخلاصه من بيانات واتساب العلنية.
- **أكاديميي الجرائم الإلكترونية** لتحليل التسريبات السلوكية الرقمية.

### 3. الرقابة الأبوية (بموافقة صريحة)
يمكن للوالدين استخدام هذه الأداة بشفافية لمراقبة أنماط استخدام أطفالهم القاصرين لواتساب، بعلم جميع الأطراف.

### 4. البحث الأكاديمي
تناسب الباحثين في علوم الحاسوب وتحليل الشبكات الاجتماعية وخصوصية البيانات الراغبين في تحليل السلوك الرقمي للمستخدمين بشكل موضوعي.
...
للتوثيق الكامل باللغة العربية، راجع [README_AR.md](README_AR.md).
